...
const uni = graduates.filter((univer) => {
  return univer.university.includes('Uni');
});
console.table(uni);
...
*/
const animalNames = zooAnimals.forEach(function(element) {
  console.log(`${element.animal_name} ${element.scientific_name}`);
});
...
console.table(largerPopulation);
